...
TIME_INTEGRATION_DEF := \
	...
	$(if $(strip $(PRJ_TIMEINT_MAX_STAGES)),-DPRJ_TIMEINT_MAX_STAGES=$(strip $(PRJ_TIMEINT_MAX_STAGES))) \
...
SRCS := \
	...
	$(SRC_DIR)/prj_timer.c \
	$(SRC_DIR)/prj_utils.c \
	rk_tableau/prj_2s2pe2pi2plinKInf.c \
...
rk_tableau/%.o: rk_tableau/%.c rk_tableau/prj_rk_tableau.h $(SRC_DIR)/prj_defs.h $(SRC_DIR)/prj_types.h
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
