...
CPPFLAGS := -Isrc -DPRJ_ENABLE_MPI -DPRJ_USE_GRAVITY=$(GRAVITY) -DPRJ_GRAV_DEBUG=$(GRAV_DEBUG) -DPRJ_TIMER=$(TIMER) -DPRJ_USE_RADIATION_M1=$(RADIATION_M1) -DPRJ_USE_RADIATION_FSA=$(RADIATION_FSA) -DPRJ_USE_RADIAL_FRAME_FSA=$(USE_RADIAL_FRAME_FSA) -DPRJ_MHD=$(MHD) -DPRJ_MHD_DEBUG=$(MHD_DEBUG) -DPRJ_LHLLD_RIEMANN=$(LHLLD_RIEMANN) $(TIME_INTEGRATION_DEF) -DPRJ_DUMP_SINGLE_PRECISION=$(DUMP_SINGLE_PRECISION) -DPRJ_MIXED_PRECISION_FLUX=$(MIXED_PRECISION_FLUX) -DPRJ_MIXED_PRECISION_TABLE=$(MIXED_PRECISION_TABLE) $(RECON_HYDRO_DEF) $(RECON_RADIATION_DEF) $(NGHOST_DEF) $(NRAD_DEF) $(NEGROUP_DEF) $(N_ANGLE_LEV_DEF) $(GIT_DEFS) $(MPI_CFLAGS) $(HDF5_CFLAGS) $(MACHINE_CPPFLAGS)
