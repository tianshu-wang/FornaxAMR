...
#define PRJ_PROVIDER_TABLE 0
#define PRJ_PROVIDER_USER 1
#ifndef PRJ_EOS_PROVIDER
#define PRJ_EOS_PROVIDER PRJ_PROVIDER_TABLE
#endif
#ifndef PRJ_OPAC_PROVIDER
#define PRJ_OPAC_PROVIDER PRJ_PROVIDER_TABLE
#endif
#if PRJ_EOS_PROVIDER != PRJ_PROVIDER_TABLE && PRJ_EOS_PROVIDER != PRJ_PROVIDER_USER
#error "PRJ_EOS_PROVIDER must be PRJ_PROVIDER_TABLE or PRJ_PROVIDER_USER"
#endif
#if PRJ_OPAC_PROVIDER != PRJ_PROVIDER_TABLE && PRJ_OPAC_PROVIDER != PRJ_PROVIDER_USER
#error "PRJ_OPAC_PROVIDER must be PRJ_PROVIDER_TABLE or PRJ_PROVIDER_USER"
#endif
...
#endif
#ifndef PRJ_FIX_MHD
#define PRJ_FIX_MHD 0
#endif
#ifndef PRJ_FIX_RAD
#define PRJ_FIX_RAD 0
#endif
#ifndef PRJ_FIX_Z4C
#define PRJ_FIX_Z4C 0
#endif
#if PRJ_FIX_MHD != 0 && PRJ_FIX_MHD != 1
#error "PRJ_FIX_MHD must be 0 or 1"
#endif
#if PRJ_FIX_RAD != 0 && PRJ_FIX_RAD != 1
#error "PRJ_FIX_RAD must be 0 or 1"
#endif
#if PRJ_FIX_Z4C != 0 && PRJ_FIX_Z4C != 1
#error "PRJ_FIX_Z4C must be 0 or 1"
#endif
